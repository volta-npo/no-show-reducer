...
[Live app](https://volta-npo.github.io/no-show-reducer/) · [Report an issue](https://github.com/volta-npo/no-show-reducer/issues) · [Volta](https://voltanpo.org)
...
```bash
git clone https://github.com/volta-npo/no-show-reducer.git
