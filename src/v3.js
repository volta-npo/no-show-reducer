export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Appointment Reminder Planner",
    "Operational table: Reminder cadence",
  ...
  "releaseChecklist": [
    ...
    "No-show Rate reaches production threshold",
    "Revenue Protected is documented with evidence",
    "Consent Safety has no unresolved blocker",
    "Cadence calendar verified",
    "Reminder templates verified",
    "No-show tracker CSV verified"
  ],
  "operations": [
