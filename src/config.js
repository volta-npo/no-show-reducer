    ...
    "criteria": [
        {
            ...
            "guidance": "Implement and verify reminder cadence planner with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify sms/email templates with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify cancellation policy copy with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "no-show-tracker",
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify no-show tracker with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
