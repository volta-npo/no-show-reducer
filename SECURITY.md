# Security Policy: No-Show Reducer

## Data handled

This local-first product may contain customer workflow data and AI/automation boundaries. Data stays in the browser unless a user exports it.
...
- For this product's domain, review these gates before handoff: SMS needs consent, Quiet hours enforced, Sensitive appointment details flagged.
